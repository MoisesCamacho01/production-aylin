...
<h4 class="fw-bold py-3 mb-4">
	<span class="text-muted fw-light" id="backButton" ><?= $distric->name ?> /</span> Barrios
	<?php foreach ($buttonTop as $row): ?>
		...
		<?php if ($row->id == 'BP0018'): ?>
			<a class="btn btn-warning text-white" href="<?= site_url('SM001/reports/maps?type=parish&code='.$distric->id) ?>">
				<?= $row->name ?>
			</a>
		<?php endif; ?>
	<?php endforeach; ?>
