...
<h4 class="fw-bold py-3 mb-4">
	<span class="text-muted fw-light"><?= $distric->name ?> /</span> Barrios
	<?php foreach ($buttonTop as $row): ?>
		...
		<?php if($row->id == 'BP0010') : ?>
			<a class="btn btn-info text-white" target="_blank" href="<?= site_url('pdf-sectors') ?>">
				<?= $row->name?>
			</a>
		<?php endif; ?>
		<?php if($row->id == 'BP0011') : ?>
			<a class="btn btn-danger text-white" href="<?= site_url('excel-sectors') ?>">
				<?= $row->name?>
			</a>
		<?php endif; ?>
	<?php endforeach; ?>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel1">Nuevo Sector</h5>
				<button type="button" class="btn-close btn-model-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-12 mb-2">
						<label for="institutionsE" class="form-label">Barrio</label>
				...
				<div class="row">
					<div class="col mb-3">
						<label for="name" class="form-label">Nombre del Sector</label>
				...
				<div class="row">
					<div class="col mb-3">
						<label for="name" class="form-label">Color del Sector</label>
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel1">Actualizar Sector</h5>
				<button type="button" class="btn-close btn-model-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-12 mb-2">
						<label for="NameCiudad" class="form-label">Barrio</label>
						<input type="text" id="NameCiudad" class="form-control" disabled value="<?= $distric->name ?>" placeholder="Ingrese una ciudad" />
				...
				<div class="row">
					<div class="col mb-3">
						<label for="nameE" class="form-label">Nombre del Sector</label>
