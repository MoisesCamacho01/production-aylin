...
<div class="row">
	<div class="col-md-6">
		<div class="row">
			<div class="col-md-3">
				<span class="fw">CANTÓN:</span>
				<br>
				<a href="<?=base_url('SMP007/cities')?>" class="fw"><?= $sector->city ?></a>
			</div>
			<div class="col-md-3">
				<span class="fw">PARROQUIA:</span>
				<br>
				<a href="<?=base_url('SMP007/parishes/'.$sector->id_city)?>" class="fw"><?= $sector->distric ?></a>
			</div>
			<div class="col-md-3">
				<span class="fw">BARRIO: </span>
				<br>
				<a href="<?=base_url('SMP007/sectors/'.$sector->id_distric)?>"><?= $sector->name ?></a>
			</div>
			<div class="col-md-3">
    ...
    <div class="col-md-6">
		...
		<?php endforeach; ?>
		<a class="btn btn-warning text-white btnViewMap" href="#" data-bs-toggle="modal" data-bs-target="#viewMapAlarmModal" zoom="15">
		<b>Visualizar Alarmas</b>
			</a>
    </div>
</div><br>
...
<div class="modal fade" id="viewMapAlarmModal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel4"> Mapa De Alarmas</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="row">
				...
				<div class="row">
					<div class="col-12 col-lg-6">
						...
						<div class="row">
							<div class="col-12 mb-2">
								<label for="managerE" class="form-label">Encargado</label>
								<select id="managerE" class="select-alarm3 form-select" name="managersE" style="width: 100%">
...
<!-- RUTAS -->
<input type="hidden" name="ruta1" value="drawSector">
<input type="hidden" name="ruta2" value="">
<input type="hidden" name="ruta3" value="reports/sector/all-alarm-sector">
