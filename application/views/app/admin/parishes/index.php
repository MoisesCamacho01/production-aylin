...
<div class="row">
	<div class="col-md-3">
		<div class="row">
			<div class="col-md-6">
				<span class="fw">CANTON:</span>
				<br>
				<a href="<?=base_url('SMP007/cities')?>" class="fw"><?= $cities->name ?></a>
			</div>
			<div class="col-md-6">
	...
	<?php foreach ($buttonTop as $row): ?>
		...
		<?php endif; ?>
	<?php endforeach; ?>
	<a class="btn btn-warning text-white btnViewMap" href="#" data-bs-toggle="modal" data-bs-target="#viewMapAlarmModal" zoom="11">
	<b>Visualizar Parroquias</b>
			</a>
    </div>
</div><br>
...
<div class="modal fade" id="viewMapAlarmModal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel4">Mapa de Parroquias</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="row">
...
<!-- RUTAS -->
<input type="hidden" name="ruta1" value="drawCity">
<input type="hidden" name="ruta2" value="reports/parish/all-parish-city">
<input type="hidden" name="ruta3" value="reports/cities/all-alarm-city">
